...
Riverbraid-Pulse-Gold is an outer Gold surface within Riverbraid.

This repository represents the Pulse domain as a visible Riverbraid surface. It helps preserve the shape of cadence-oriented verification and signal work without implying that this repository currently extends the canonical Evaluation Kit verification floor.
